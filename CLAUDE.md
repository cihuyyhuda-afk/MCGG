...
- **Diagnostics**: Runtime Status and Test tabs expose binding readiness, managed reference refresh, round state, battle manager fields, behavior API state, all manager entries, and opponent prediction signals.
